    ...
    <div id='contact' className='w-full lg:h-screen'>
        ...
        <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full rounded-xl '>
                <div>
                    <img className='rounded-xl hover:scale-105 ease-in duration-300' src='https://images.unsplash.com/photo-1557200134-90327ee9fafa?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80'></img>
                </div>
                <div>
                    <h2 className='py-2'>Ziyoviddin Akramov</h2>
            ...
            <div className='col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4'>
                ...
                <form>
                    ...
                    <button onClick={handleSendMessage} className='w-full text-gray-100 p-4 mt-4'>Send Message</button>
                </form>
